...
if(isset($_POST['reportsem']) && $_POST['deptcode'] != 0 && $_POST['sem'] != 0) {
    ...
    $html_footer = '</body></html>';
        ...
        if($tableBody != null && $tableHeader != null) {
            ...
            echo "<script>alert('Error in generating report,please check with the data');
    ...
    $filename = $deptcode.'_'.$dept_codes_ex[$deptcode].'_sem_'.$sem.'_report.pdf';
